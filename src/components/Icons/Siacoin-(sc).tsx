...
const SvgSiacoinSc = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      fill="#555F62"
      d="M16 15.25V12c0-2.35-1.9-4.25-4.25-4.25S7.5 9.65 7.5 12s1.9 4.25 4.25 4.25H15c.55 0 1-.45 1-1ZM5 6.88a1.88 1.88 0 1 0 0-3.76 1.88 1.88 0 0 0 0 3.76Z"
    />
  </svg>
);
export default SvgSiacoinSc;
