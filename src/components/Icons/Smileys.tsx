...
const SvgSmileys = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#555F62"
      d="M10 1H4C2.34 1 1 2.34 1 4v6c0 1.66 1.34 3 3 3h4.5c0-2.48 2.02-4.5 4.5-4.5V4c0-1.66-1.34-3-3-3ZM3.77 4.27c.77-.55 1.82-.56 2.61-.02.34.23.43.7.2 1.04-.23.34-.7.43-1.04.2a.781.781 0 0 0-.91.01c-.13.09-.28.13-.43.13-.23 0-.47-.11-.61-.31a.753.753 0 0 1 .18-1.05Zm5.5 3.97c-.26.33-.73.38-1.05.12-.35-.28-.77-.43-1.22-.43-1 0-1.83.76-1.94 1.74h2.1c.41 0 .75.34.75.75s-.34.75-.75.75H4.84c-.71 0-1.29-.58-1.29-1.29 0-1.9 1.55-3.45 3.45-3.45.78 0 1.55.27 2.16.76.32.26.37.73.11 1.05Zm1.31-2.95c-.23.34-.7.43-1.04.2a.781.781 0 0 0-.91.01c-.13.09-.28.13-.43.13-.23 0-.47-.11-.61-.31a.753.753 0 0 1 .18-1.05c.77-.55 1.82-.56 2.61-.02.34.23.43.7.2 1.04ZM18.22 16.68a.363.363 0 0 0-.28-.12h-3.88c-.11 0-.21.04-.28.12-.07.08-.11.19-.09.29A2.328 2.328 0 0 0 16 19.05c1.19 0 2.18-.89 2.31-2.08a.376.376 0 0 0-.09-.29Z"
    />
    <path
      fill="#555F62"
