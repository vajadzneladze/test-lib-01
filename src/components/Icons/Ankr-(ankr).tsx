...
const SvgAnkrAnkr = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#555F62"
      d="M16.44 12c0-2.45-1.99-4.44-4.44-4.44S7.56 9.55 7.56 12c0 2.2 1.61 4.02 3.71 4.37 0 .03-.01.05-.01.07V22c0 .41.34.75.75.75s.75-.34.75-.75v-5.56c0-.03-.01-.05-.01-.07A4.43 4.43 0 0 0 16.44 12Z"
    />
  </svg>
);
