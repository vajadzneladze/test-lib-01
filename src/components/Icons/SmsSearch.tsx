...
const SvgSmsSearch = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#555F62"
      d="m22.65 21.45-.75-.75a3.756 3.756 0 0 0-3.14-5.82c-2.08 0-3.76 1.68-3.76 3.75 0 2.07 1.68 3.76 3.76 3.76.76 0 1.47-.23 2.06-.62l.75.75c.15.15.34.22.54.22s.39-.07.54-.22c.3-.29.3-.77 0-1.07Z"
    />
  </svg>
);
