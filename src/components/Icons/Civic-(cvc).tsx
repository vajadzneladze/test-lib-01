...
const SvgCivicCvc = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <path
      fill="#555F62"
      d="M14.3 10.13c.28 1.1-.21 2.12-1.05 2.64v1.98a1.25 1.25 0 0 1-2.5 0v-1.98a2.373 2.373 0 0 1-1.13-2.02c0-1.52 1.44-2.7 3.02-2.28.8.21 1.45.86 1.66 1.66Z"
    />
    <path
      fill="#555F62"
