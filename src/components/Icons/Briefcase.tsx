...
const SvgBriefcase = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#555F62"
      d="M20.874 13.734a.509.509 0 0 1 .725.502l-.359 3.954c-.21 2-1.03 4.04-5.43 4.04H8.19c-4.4 0-5.22-2.04-5.43-4.03l-.34-3.748a.508.508 0 0 1 .715-.506c1.14.516 3.242 1.43 4.542 1.77a.57.57 0 0 1 .369.315c.607 1.298 1.923 1.989 3.824 1.989 1.882 0 3.215-.717 3.824-2.019a.572.572 0 0 1 .37-.315c1.38-.363 3.618-1.385 4.81-1.952Z"
    />
  </svg>
);
