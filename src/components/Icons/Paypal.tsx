...
const SvgPaypal = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fill="#555F62"
      d="M21 11c0 1.38-.56 2.63-1.46 3.54-.91.9-2.16 1.46-3.54 1.46h-2.15a1 1 0 0 0-.99.84l-.72 4.32a1 1 0 0 1-.99.84H8.22a.95.95 0 0 1-.48-.12c-.22-.12-.08-.41.16-.51.9-.29 1.56-1.06 1.7-2.02l.64-4.42c.04-.25.25-.43.49-.43H13c2.01 0 3.9-.78 5.3-2.19.83-.82 1.45-1.83 1.81-2.92.08-.25.41-.3.52-.07.24.52.37 1.08.37 1.68Z"
    />
  </svg>
);
