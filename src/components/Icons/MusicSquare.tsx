...
const SvgMusicSquare = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#555F62"
      d="M14.54 13.67c-.36 0-.65.29-.65.65 0 .36.29.65.65.65.36 0 .65-.29.65-.65a.662.662 0 0 0-.65-.65ZM9.06 14.66c-.36 0-.65.29-.65.65 0 .36.29.65.65.65.36 0 .65-.29.65-.65 0-.36-.29-.65-.65-.65Z"
    />
    <path
      fill="#555F62"
