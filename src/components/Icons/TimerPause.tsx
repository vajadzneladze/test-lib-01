...
const SvgTimerPause = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#555F62"
      d="M14.89 3.45H9.11c-.4 0-.72-.32-.72-.72 0-.4.32-.73.72-.73h5.78c.4 0 .72.32.72.72 0 .4-.32.73-.72.73ZM14 19.97v-2.94c0-1.81 1.22-3.03 3.03-3.03h2.94c.23 0 .45.02.66.06.02-.24.04-.48.04-.73 0-4.79-3.89-8.68-8.67-8.68-4.78 0-8.67 3.89-8.67 8.68C3.33 18.11 7.22 22 12 22c.85 0 1.66-.14 2.44-.36a3.22 3.22 0 0 1-.44-1.67ZM12.75 13c0 .41-.34.75-.75.75s-.75-.34-.75-.75V8c0-.41.34-.75.75-.75s.75.34.75.75v5Z"
    />
    <path
      fill="#555F62"
