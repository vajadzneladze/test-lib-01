...
const SvgGallerySlash = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      fill="#555F62"
      d="M21.77 2.23c-.3-.3-.79-.3-1.09 0L2.23 20.69c-.3.3-.3.79 0 1.09a.758.758 0 0 0 1.08-.01L21.77 3.31c.31-.3.31-.78 0-1.08ZM9 10.38a2.38 2.38 0 1 0 0-4.76 2.38 2.38 0 0 0 0 4.76ZM21.61 5.39l-1.22 1.22c.08.37.11.77.11 1.2v4.8l-.13-.11c-.78-.67-2.04-.67-2.82 0l-4.16 3.57c-.71.61-1.83.67-2.61.15L5.4 21.6c.04.02.08.03.12.04.27.09.54.16.83.22.1.02.2.04.31.05.37.05.75.09 1.15.09h8.38c3.64 0 5.81-2.17 5.81-5.81V7.81c0-.9-.13-1.71-.39-2.42Z"
    />
    <path
      fill="#555F62"
