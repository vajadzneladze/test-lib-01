...
export const StyledButton = styled(DxButton) <StyledButtonProps>`
  ...
  &:hover {
    background-color: ${({ variant, theme }) => variant === 'contained' ? theme.color.semantic.positive_80 : 'transparent'};
    border: ${({ variant, theme }) => variant === 'outlined' ? `1px solid ${theme.color.semantic.positive_80}` : 'none'};
    color: ${({ variant, theme }) => variant === 'contained' ? theme.color.text.static_primary : theme.color.semantic.positive_80};
  }
  &:active {
    background-color: ${({ variant, theme }) => variant === 'contained' ? theme.color.semantic.positive_120 : 'transparent'};
    border: ${({ variant, theme }) => variant === 'outlined' ? `1px solid ${theme.color.semantic.positive_80}` : 'none'};
    color: ${({ variant, theme }) => variant === 'contained' ? theme.color.text.static_primary : theme.color.semantic.positive_120};
  }
